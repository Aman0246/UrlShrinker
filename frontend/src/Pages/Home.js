...
<input type="text" onClick={resul} value={show} className='a border-2 border-black rounded-md hover:underline hover:underline-offset-4 cursor-pointer p-4 w-3/5'/>
{/* <button type='Submit' className='border-2 font-medium border-sky-500 rounded-md p-4 mx-8 bg-sky-500/100  hover:underline hover:underline-offset-4 '>Generate</button> */}
</form>):("")}
    </div></div>
 </div>
